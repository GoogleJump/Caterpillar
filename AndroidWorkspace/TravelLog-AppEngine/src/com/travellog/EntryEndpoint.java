...
public class EntryEndpoint {
	...
	@ApiMethod(name = "listEntry", path = "listEntry")
	public CollectionResponse<Entry> listEntry(
			@Nullable @Named("cursor") String cursorString,
			@Nullable @Named("limit") Integer limit, @Named("tripPoster") String tripPoster) {
		...
		try {
			...
			Query query = mgr.createQuery("select from Entry as Entry where Entry.tripPoster = :t").setParameter("t", tripPoster);
	 ...
	 */
	@ApiMethod(name = "getEntry", path = "getEntry")
