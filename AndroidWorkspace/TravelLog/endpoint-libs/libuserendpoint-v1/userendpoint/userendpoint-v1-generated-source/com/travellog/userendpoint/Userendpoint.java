...
public class Userendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public ListUser listUser(java.lang.String email) throws java.io.IOException {
    ListUser result = new ListUser(email);
    initialize(result);
    return result;
  }
  ...
  public class ListUser extends UserendpointRequest<com.travellog.userendpoint.model.CollectionResponseUser> {
    ...
    private static final String REST_PATH = "listUser";
     ...
     * @since 1.13
     */
    protected ListUser(java.lang.String email) {
    ...
    public ListUser setEmail(java.lang.String email) {
      this.email = email;
      return this;
    }
